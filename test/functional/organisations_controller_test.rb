...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { ackronym: @organisation.ackronym, furl: @organisation.furl, homepage: @organisation.homepage, launch_date: @organisation.launch_date, title: @organisation.title }
    end
  ...
  test "should update organisation" do
    put :update, id: @organisation, organisation: { ackronym: @organisation.ackronym, furl: @organisation.furl, homepage: @organisation.homepage, launch_date: @organisation.launch_date, title: @organisation.title }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
