...
feature 'Filtering urls for a site' do
  before :each do
    ...
    @site1 = host.site
    @site2 = create :site
    @content_type1 = create :content_type, type: 'Bling', subtype: nil
    ...
    @url1 = create :url, url: 'http://www.naturalengland.org.uk/site', site: @site1, 
      content_type: @content_type1, state: 'finished'
    @url2 = create :url, url: 'http://www.naturalengland.org.uk/about_us/default.aspx', site: @site1, content_type: @content_type2
    @url3 = create :url, url: 'http://www.naturalengland.org.uk/contact_us', site: @site1, 
      content_type: @content_type1, state: 'unfinished'
    @url4 = create :url, url: 'http://www.dfid.org.uk/please_contact_us', site: @site2
    @url5 = create :url, url: 'http://www.naturalengland.org.uk/help', site: @site1, content_type: @content_type1

    login_as_stub_user
  end

  scenario 'Viewing all urls for a site and filtering them by content type and state', js: true do
